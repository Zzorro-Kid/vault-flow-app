...
class AppColors {
  ...
  static const Color balanceEnd = Color(0xFF357ABD);
  static const Color incomeStart = Color(0xFF4ECDC4);
  ...
  static const Color periodButtonTextInactive = Color(0xFF616161);
